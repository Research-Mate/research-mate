...
The project produces static files in `dist/` and uses a relative Vite base path, which makes it portable across common static hosts.

### GitHub Pages

1. Push the repository to GitHub.
2. Add a GitHub Actions workflow that runs `npm ci` and `npm run build`.
3. Upload the generated `dist/` directory as the Pages artifact.
...
## Competition and demo notes

Suggested demonstration flow:

1. Open the app on the landing section and explain that it is guidance, not proposal generation.
2. Select **Load sample** to show a complete school-level project.
3. Analyze the sample and point out that even a good draft receives specific improvements.
4. Show the six-link alignment review and methodology snapshot.
5. Return to the form, change the approach or use vague wording, and analyze again to prove that feedback changes with the input.
6. Show the checklist, local draft recovery after refresh, and print / PDF report.
7. End by explaining privacy, academic integrity, and the teacher-supervisor handoff.

## How Codex and GPT-5.6 supported the build

> Replace the placeholders below with your own truthful development record before submitting the project.
